...
param['n_modes_to_show_sr'] = 750#850
param['n_modes_to_control_sr'] = param['n_modes_to_show_sr']#700 # should be inferior to param['n_modes_to_show_sr']

param['n_modes_to_show_oversampled'] = 1200
