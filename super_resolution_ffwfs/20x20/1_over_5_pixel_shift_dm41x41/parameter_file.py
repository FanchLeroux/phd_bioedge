...
param['n_actuator'] = 2*param['n_subaperture']+1 # number of actuators
...
# name of the system
param['filename'] = '_DM_'+str(param['n_actuator'])+'x'+str(param['n_actuator']) +'_'+ param['optical_band'] +'_band_'+ str(param['n_subaperture'])+'x'+ str(param['n_subaperture'])\
