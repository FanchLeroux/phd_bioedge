...
# modal basis
filename_fourier_modes = ("diagonal_fourier_modes_1152_pixels_in_slm_pupil_"
                          "20_subapertures.npy")

# %% Load fourier modes

fourier_modes = np.load(
    dirc_data / "phd_bioedge" / "manip" / "slm_screens" / "modal_basis" /
    "fourier_modes" / filename_fourier_modes,
    mmap_mode='r')
...
fourier_mode_mode_full_slm = np.zeros((slm_shape[0], slm_shape[1]))
fourier_mode_mode_full_slm[pupil_center[0]-fourier_modes.shape[0]//2:
                           pupil_center[0]+fourier_modes.shape[0]//2,
                           pupil_center[1]-fourier_modes.shape[1]//2:
                           pupil_center[1]+fourier_modes.shape[1]//2] =\
    fourier_modes[:, :, n_fourier_mode]

command = display_phase_on_slm(
    stroke*fourier_mode_mode_full_slm,
