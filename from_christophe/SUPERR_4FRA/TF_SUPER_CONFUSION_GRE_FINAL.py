...
TFx_bio,TFy_bio,Mvp,Mvm,Mhp,Mhm, Omega_gre, PSF_gre, Omega0_gre =  build_bio_blunt_syn_c1(modu_eff_blunt,0.,SZ,sz,pupil=pupil,PSF=None,convolvPSF=True,TYPE=None)
...
plt.figure()
plt.title('ALIASING: BI-O EDGE',fontsize=18)
plt.imshow(CONF_BIO0_RMS[SZr//2-idx_fc : SZr//2+idx_fc ,SZr//2-idx_fc : SZr//2+idx_fc ],origin='lower',extent=[-liim/2,liim/2,-liim/2,liim/2])
#plt.xlabel(r'$m^{-1}$',fontsize=18)
plt.xlabel('[1/d]',fontsize=15)
plt.colorbar()
plt.show(block=False)

#plt.savefig('FIGURES_OK/SUPER_R/CONFUSION_MAP_BIO_REV.pdf')
...
plt.figure()
plt.title('ALIASING: BI-O EDGE \n +SUPER-RESOLUTION',fontsize=18)
plt.imshow(CONF_BIO1_RMS[SZr//2-idx_fc : SZr//2+idx_fc ,SZr//2-idx_fc : SZr//2+idx_fc ],origin='lower',extent=[-liim/2,liim/2,-liim/2,liim/2])
#plt.xlabel(r'$m^{-1}$',fontsize=18)
plt.xlabel('[1/d]',fontsize=15)
plt.colorbar()
plt.show(block=False)

#plt.savefig('FIGURES_OK/SUPER_R/CONFUSION_MAP_BIO_SUPER_R_REV.pdf')
