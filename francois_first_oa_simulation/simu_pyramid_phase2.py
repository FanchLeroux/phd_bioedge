# -*- coding: utf-8 -*-
"""
Created on Wed Oct  9 13:47:09 2024
...
focal_plane_complex_amplitude = np.abs(focal_plane_complex_amplitude) * pywfs_amplitude_mask[0] * np.exp(1j*focal_plane_phase_shift_11)
focal_plane_irradiance = np.abs(focal_plane_complex_amplitude)**2
...
print(np.round(conjugated_pupil_plane_irradiance.sum(), 2))
...
axs2[0,0].imshow(np.abs(focal_plane_complex_amplitude)*pywfs_amplitude_mask[0])
axs2[0,1].imshow(np.abs(focal_plane_complex_amplitude)*pywfs_amplitude_mask[1])
axs2[1,0].imshow(np.abs(focal_plane_complex_amplitude)*pywfs_amplitude_mask[2])
axs2[1,1].imshow(np.abs(focal_plane_complex_amplitude)*pywfs_amplitude_mask[3])
