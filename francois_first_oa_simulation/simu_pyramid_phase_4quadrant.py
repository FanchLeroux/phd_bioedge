...
focal_plane_phase_shift_12 = Tilt(delta_phi=delta_phi_focal_plane, size_support=focal_plane_complex_amplitude.shape, direction='x') +\
                             Tilt(delta_phi=delta_phi_focal_plane, size_support=focal_plane_complex_amplitude.shape, direction='y')

focal_plane_phase_shift_21 = Tilt(delta_phi=-delta_phi_focal_plane, size_support=focal_plane_complex_amplitude.shape, direction='x') +\
                             Tilt(delta_phi=-delta_phi_focal_plane, size_support=focal_plane_complex_amplitude.shape, direction='y')

focal_plane_phase_shift_22 = Tilt(delta_phi=delta_phi_focal_plane, size_support=focal_plane_complex_amplitude.shape, direction='x') +\
                             Tilt(delta_phi=-delta_phi_focal_plane, size_support=focal_plane_complex_amplitude.shape, direction='y')
                             
pywfs_complex_amplitude_mask = pywfs_amplitude_mask[0] * np.exp(1j*focal_plane_phase_shift_11) +\
                               pywfs_amplitude_mask[1] * np.exp(1j*focal_plane_phase_shift_12) +\
                               pywfs_amplitude_mask[2] * np.exp(1j*focal_plane_phase_shift_21) +\
                               pywfs_amplitude_mask[3] * np.exp(1j*focal_plane_phase_shift_22)
...
print(np.sum(np.abs(conjugated_pupil_plane_complex_amplitude * pywfs_amplitude_mask[0])**2))
print(np.sum(np.abs(conjugated_pupil_plane_complex_amplitude * pywfs_amplitude_mask[1])**2))
print(np.sum(np.abs(conjugated_pupil_plane_complex_amplitude * pywfs_amplitude_mask[2])**2))
print(np.sum(np.abs(conjugated_pupil_plane_complex_amplitude * pywfs_amplitude_mask[3])**2))
print(np.sum(np.abs(conjugated_pupil_plane_complex_amplitude)**2))
